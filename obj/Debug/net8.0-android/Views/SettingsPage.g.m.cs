...
#nullable disable
	...
	partial class SettingsPage
	{
		...
		private void InitializeAfterConstructor()
		{
			...
			if (this.BindingContext is global::EXAM_MAUI.ViewModels.SettingsViewModel dataRoot0)
			{
		...
		private void this_BindingContextChanged(object sender, global::System.EventArgs e)
		{
			...
			if (((global::Microsoft.Maui.Controls.Element)sender).BindingContext is global::EXAM_MAUI.ViewModels.SettingsViewModel dataRoot)
			{
		...
		class SettingsPage_Bindings_this
		{
			...
			global::EXAM_MAUI.ViewModels.SettingsViewModel _dataRoot;
			SettingsPage_BindingsTrackings_this _bindingsTrackings;

			public void Initialize(SettingsPage targetRoot, global::EXAM_MAUI.ViewModels.SettingsViewModel dataRoot)
			{
			...
			private void Update0_Title(global::EXAM_MAUI.ViewModels.SettingsViewModel value)
			{
...
#line default
			...
			class SettingsPage_BindingsTrackings_this
			{
				...
				public void SetPropertyChangedEventHandler0(global::EXAM_MAUI.ViewModels.SettingsViewModel value)
				{
				...
				private void OnPropertyChanged0(object sender, global::System.ComponentModel.PropertyChangedEventArgs e)
				{
					...
					var typedSender = (global::EXAM_MAUI.ViewModels.SettingsViewModel)sender;
